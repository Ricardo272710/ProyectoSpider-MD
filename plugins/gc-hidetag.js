...
**/
    ...
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/Ghf2fHMzBLA1iuYAXstOb4'}}}}}, {});
    }
  }
};
handler.command = /^(aviso|n|noti|notify|viso|hidetag)$/i;
handler.group = true;
handler.admin = true;
