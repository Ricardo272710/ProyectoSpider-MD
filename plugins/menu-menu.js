 ...
 *┃➤* _${usedPrefix}añadircoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝗙𝗶𝗼𝗿𝗲 𝗕𝗼𝘁 🕷️', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
...
handler.command = /^(menucompleto|menu|menú\?)$/i
